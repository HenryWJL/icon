...
python scripts/train.py task=open_box algo=diffusion_transformer train.seed=100
python scripts/train.py task=take_lid_off_saucepan algo=diffusion_transformer train.seed=100
python scripts/train.py task=close_drawer algo=diffusion_transformer train.seed=100
