...
python scripts/train.py task=open_box algo=icon_diffusion_unet algo.policy.obs_encoder.image_encoder.backbone.enable_fps=false
python scripts/train.py task=open_box algo=icon_diffusion_unet algo.policy.obs_encoder.image_encoder.backbone.enable_weighted_loss=false
python scripts/train.py task=open_box algo=icon_diffusion_unet algo.policy.obs_encoder.image_encoder.backbone.enable_fps=false algo.policy.obs_encoder.image_encoder.backbone.enable_weighted_loss=false
