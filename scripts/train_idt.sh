...
python scripts/train.py task=play_jenga algo=icon_diffusion_transformer train.seed=0
python scripts/train.py task=open_microwave algo=icon_diffusion_transformer train.seed=0
